...
<tbody>
<tr>
<td class="new_open">PT-1596</td><td class="new_open">Avidemux</td><td class="new_open">avidemux.org </td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">Logiciel libre de Montage vid&eacute;o</td>
</tr>
<tr>
<td class="new_open">PT-1597</td><td class="new_open">Calibre</td><td class="new_open">Calibre-ebook</td><td></td><td class="statut_R">R</td><td></td><td class="comm_italic">Gestionnaire de biblioth&egrave;que num&eacute;rique</td>
</tr>
<tr>
<td class="new_open">PT-1601</td><td class="new_open">Evince (pour les postes Linux)</td><td class="new_open">gnome.org</td><td></td><td class="statut_R">R</td><td></td><td class="comm_italic">Visionneuse de documents sous Linux. Produit libre.</td>
</tr>
<tr>
<td class="new_open">PT-1600</td><td class="new_open">FreeFileSync</td><td class="new_open">freefilesync.org</td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">Logiciel libre de Synchronisation, sauvegarde de donn&eacute;es</td>
</tr>
<tr>
<td class="new_open">PT-1589</td><td class="new_open">GreenShot</td><td class="new_open">GreenShot</td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">Logiciel de Capture d&rsquo;&eacute;cran</td>
</tr>
<tr>
<td class="new_open">PT-1591</td><td class="new_open">Inkscape</td><td class="new_open">Porojet Inkscape</td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">Logiciel de cr&eacute;ation de dessins vectoriels. </td>
</tr>
<tr>
<td class="new_open">MT-1588</td><td class="new_open">Joplin</td><td class="new_open">Joplin</td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">Logiciel multiplateforme de prise de notes synchronisables</td>
</tr>
<tr>
<td class="new_open">PT-1590</td><td class="new_open">Obs Studio</td><td class="new_open">Open Broadcaster Software</td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">R&eacute;gie video pour enregistrement et/ou streaming. https://obsproject.com/
</td>
</tr>
<tr>
<td class="new_open">PT-1579</td><td class="new_open">PDF Sam Basic (PDF Split and Merge)</td><td class="new_open">pdfsam.org</td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">Logiciel de Traitement PDF</td>
</tr>
<tr>
<td class="new_nonopen">PT-1592</td><td class="new_nonopen">XN View</td><td class="new_nonopen">XN View</td><td></td><td class="statut_R">R</td><td></td><td class="comm_italic">Visualisation retouche d'images. Produit sous licence.</td>
</tr>
<tr>
<td class="maj_nonopen">PT-1325</td><td class="maj_nonopen">MS Office</td><td class="maj_nonopen">Microsoft</td><td>Derniere version support&eacute;e</td><td class="statut_A">A</td><td></td><td class="comm_italic">&agrave; jour des Services Packs et des correctifs de s&eacute;curit&eacute;.Configurer par d&eacute;faut sur les formats ODF. Produit sous licence.</td>
</tr>
<tr>
<td class="new_open">PT-1577</td><td class="new_open">Collabora Office (service web)</td><td class="new_open">Collabora</td><td></td><td class="statut_R">R</td><td></td><td class="comm_italic">Suite bureautique en ligne.</td>
</tr>
<tr>
...
<tr>
<td class="new_open">PT-1578</td><td class="new_open">M&eacute;lanie</td><td class="new_open"></td><td></td><td class="statut_R">R</td><td></td><td class="comm_italic">Client de messagerie</td>
</tr>
<tr>
...
<tr>
<td class="new_open">PT-1575</td><td class="new_open">Chromium</td><td class="new_open"></td><td>Version LTS ou ESR disponible</td><td class="statut_R">R</td><td></td><td class="comm_italic">Navigateur d&eacute;di&eacute; aux solutions de Visioconf&eacute;rences</td>
</tr>
<tr>
...
<tr>
<td class="new_nonopen">PT-1576</td><td class="new_nonopen">Microsoft Edge</td><td class="new_nonopen">Microsoft</td><td></td><td class="statut_A">A</td><td></td><td class="comm_italic">Navigateur sur la souche Windows</td>
</tr>
<tr>
...
<tbody>
<tr>
<td class="new_nonopen">MT-1584</td><td class="new_nonopen">Microsoft Project</td><td class="new_nonopen"></td><td></td><td class="statut_A">A</td><td></td><td class="comm_italic">Gestion de projets. Produit sous licence.</td>
</tr>
<tr>
...
<tr>
<td class="new_open">MT-1585</td><td class="new_open">ProjeQtor (service web)</td><td class="new_open">Projeqtor.org</td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">Gestion de projets. https://www.projeqtor.org
</td>
</tr>
<tr>
<td class="new_open">MT-1583</td><td class="new_open">Wekan (service web)</td><td class="new_open">wekan.github.io</td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">Gestion de t&acirc;ches (outil de Kanban open source)</td>
</tr>
</tbody>
</table>
<h3>
...
<tr>
<td class="new_open">MT-1587</td><td class="new_open">Drawio</td><td class="new_open">JGraph Ltd</td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">Outil de Dessin et diagrammes. Version Desktop inscrite au SILL</td>
</tr>
<tr>
...
<tr>
<td class="new_open">MT-1593</td><td class="new_open">Freeplane</td><td class="new_open">freeplane.org</td><td>Version SILL</td><td class="statut_R">R</td><td></td><td class="comm_italic">Cartes heuristiques</td>
</tr>
<tr>
<td class="new_nonopen">MT-1594</td><td class="new_nonopen">Autocad</td><td class="new_nonopen">Autodesk</td><td></td><td class="statut_A">A</td><td></td><td class="comm_italic">Logiciel de Dessin Assist&eacute; par Ordinateur. Sous Licence.</td>
</tr>
<tr>
<td class="new_open">MT-1595</td><td class="new_open">Sweet Home 3D </td><td class="new_open">Eteks</td><td></td><td class="statut_R">R</td><td></td><td class="comm_italic">Logiciel libre de Dessin Assist&eacute; par Ordinateur</td>
</tr>
</tbody>
</table>
<h3>
